...
export const LEVELS = [
  ...
  // ---------------------------------------------------------------- L2
  {
    ...
    stages: [
      { id: "s1", type: "quiz", title: "Cardinality", question: "Satu department dapat memiliki banyak mahasiswa, tetapi satu mahasiswa hanya terdaftar pada satu department. Apa jenis kardinalitas ini?", options: ["One-to-Many", "Many-to-Many", "One-to-One", "Tidak ada relasi"], correctIndex: 0, explainCorrect: "Benar — dari sisi department ke students adalah one-to-many.", xp: 10, graded: false },
      { id: "s2", type: "quiz", title: "Menghubungkan Entity", question: "Agar tabel students terhubung secara relasional ke departments, kolom apa yang sebaiknya ditambahkan pada tabel students?", options: ["dept_id sebagai foreign key merujuk ke departments.dept_id", "Menyalin seluruh kolom departments ke students", "Menghapus tabel departments", "Mengubah primary key students menjadi dept_id"], correctIndex: 0, xp: 10, graded: false },
      { id: "s3", type: "quiz", title: "Entity ke Tabel", question: "Sebuah entity pada ERD umumnya diimplementasikan menjadi apa pada database relasional?", options: ["Tabel", "Kolom", "Baris", "Index"], correctIndex: 0, xp: 10, graded: false },
      {
...
WHERE student_id NOT IN (
  ...
  // --------------------------------------------------------------- L10
  {
    ...
    stages: [
      { id: "s1", type: "quiz", title: "Masalah Desain", question: "Pada raw_registrations, nilai student_city berulang setiap kali mahasiswa mengambil mata kuliah baru. Apa masalah desain ini?", options: ["Redundansi data akibat belum ternormalisasi", "Tabel sudah dalam bentuk 3NF", "Kesalahan tipe data", "Kekurangan primary key"], correctIndex: 0, xp: 10, graded: false },
      { id: "s2", type: "quiz", title: "Langkah Perbaikan", question: "Langkah paling tepat memperbaiki tabel ini adalah...", options: ["Memecah menjadi beberapa tabel terpisah (mahasiswa, mata kuliah) dan menghubungkannya dengan foreign key", "Menghapus semua baris duplikat course_name", "Mengubah course_credits menjadi TEXT", "Menggabungkan seluruh kolom menjadi satu kolom teks panjang"], correctIndex: 0, xp: 10, graded: false },
      {
  ...
  // --------------------------------------------------------------- L11
  {
    ...
    stages: [
      ...
      },
      {
        ...
        starterSql: "CREATE INDEX idx_students_dept ON students(dept_id);\n\nEXPLAIN QUERY PLAN SELECT * FROM students WHERE dept_id = 2;",
  ...
  // --------------------------------------------------------------- L13
  {
    ...
    stages: [
      { id: "s1", type: "quiz", title: "Sintaks MySQL Procedure", question: "Pada MySQL, blok logika prosedur biasanya diapit perintah apa agar titik koma di dalamnya tidak memutus blok?", options: ["DELIMITER (umumnya diubah sementara menjadi //)", "COMMIT", "ROLLBACK", "EXPLAIN"], correctIndex: 0, xp: 10, graded: false },
      {
